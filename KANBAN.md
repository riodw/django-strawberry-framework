...
- Four archived stubs still carry the boilerplate 'expand it into the full builder-format spec' preamble the release falsified: `spec-013`, `spec-016`, `spec-024`, `spec-026` (measured by the spec-011 residual cycle, re-measured in `docs/builder/bld-011-r2-doc_completion_archive_audit.md`; `spec-012` was the fifth until the spec-012 residual cycle moved its preamble into `docs/SPECS/appx/spec-012-version_release_alignment-0_0_4-rationale.md` on 2026-08-15, so a later sweep should measure four and not re-derive five). Each awaits its own residual-completion cycle of the spec-007 / spec-011 shape - no card of its own, per the spec-009 disposition this board already records - and this card's every-shipped-spec rationale-companion decision sets how many more such cycles the board owes.
