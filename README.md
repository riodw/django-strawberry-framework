...
<!-- TODO(spec-035 Slice 4): add the optimizer robustness status note here.
Pseudocode: mention that the optimizer now passes through evaluated querysets,
suppresses column projection for non-query operations, and narrows fragment
planning by type condition without adding a public API. -->
