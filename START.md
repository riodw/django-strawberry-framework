...
- Build in slices. Each slice ships with tests in the same change. The DjangoType spec breaks itself into seven slices; future specs should follow the same shape.
