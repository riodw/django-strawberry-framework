...
paragraph when the order live HTTP tests ship in 0.0.8. Pseudo: mention
...
examples/fakeshop/test_query/test_library_api.py. Do not touch package version
fields unless the maintainer explicitly gives the version-bump command. -->
