...
Predecessors: [`docs/GLOSSARY.md`][glossary] (entries [`DjangoType`][glossary-djangotype], [`Meta.fields`][glossary-metafields], [`get_queryset` visibility hook][glossary-get-queryset-visibility-hook], [`DjangoOptimizerExtension`][glossary-djangooptimizerextension], [`Relation handling`][glossary-relation-handling], [`Meta.primary`][glossary-metaprimary], [`Relay Node integration`][glossary-relay-node-integration], [`DjangoListField`][glossary-djangolistfield]), [`KANBAN.md`][kanban] card `DONE-016-0.0.7` (was `DONE-016-0.0.7` until Slice 5's column move), predecessor spec [`docs/SPECS/spec-011-relay_interfaces-0_0_5.md`][spec-011] (Decision 9 — async `get_queryset` shape) and [`docs/SPECS/spec-014-meta_primary-0_0_6.md`][spec-014] (multiple `DjangoType`s per model).
...
- [`Relay Node integration`][glossary-relay-node-integration] — non-Relay list shape is the entire point of this card; the Relay sibling lives under [`DjangoConnectionField`][glossary-djangoconnectionfield] in `TODO-ALPHA-023-0.0.9` (see [Decision 8](#decision-8--out-of-scope-boundary-with-djangoconnectionfield)).
...
`DjangoListField` and `DjangoConnectionField` ([`TODO-ALPHA-023-0.0.9`][kanban]) are sibling primitives. Both bind to a `DjangoType`; both apply `cls.get_queryset(...)`; both cooperate with the optimizer.
...
- `DjangoConnectionField` and Relay-shaped pagination: `TODO-ALPHA-023-0.0.9` in [`KANBAN.md`][kanban].
...
<!-- docs/SPECS/ -->
[spec-011]: spec-011-relay_interfaces-0_0_5.md
