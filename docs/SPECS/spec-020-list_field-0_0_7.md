...
- **Revision 2** (post-feedback review) — three high-severity corrections plus three medium and two low cleanups; all surfaced by the adversarial review of revision 1:
...
- **Revision 4** (post-rev3 review — the second adversarial pass) — three high-severity corrections plus two medium and one low, all surfaced after a closer audit against the installed Strawberry behavior and the live KANBAN card body:
