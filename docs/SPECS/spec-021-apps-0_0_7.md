...
- **Revision 2** (post-rev1 review) — two high-severity corrections plus one low cleanup; all surfaced by the rev1 reviewer:
...
- **Revision 3** (post-rev2 review) — one high-severity correction plus three low cleanups; all surfaced by the rev2 reviewer:
...
- **Revision 4** (post-rev3 review) — four low-severity corrections, all propagation / consistency cleanups against rev3's H1 docstring landing; no architectural change. Plus two informational follow-ups the rev3 reviewer flagged as non-findings but worth fixing for hygiene:
...
- **Revision 5** (post-rev4 review) — one medium-severity correction plus two low-severity propagation cleanups against rev4's L3 (D100 citation) and L4 (Decision 8 broadening) landings; no architectural change:
