...
Status: draft (revision 5, post-rev4 feedback).
...
- **Revision 2** (post-rev1 review) — one high-severity correction, two medium-severity corrections, and one low-severity propagation cleanup; all surfaced by the rev1 reviewer:
...
- **Revision 3** (post-rev2 review) — one medium-severity propagation cleanup plus four low-severity wording / hygiene corrections; all surfaced by the rev2 reviewer:
...
- **Revision 4** (post-rev3 review) — one medium-severity correction, four low-severity wording / structural fixes, and one informational author's-call settled; all surfaced by the rev3 reviewer:
...
- **Revision 5** (post-rev4 review) — one medium-severity propagation gap plus one low-severity inaccuracy in the Risks section; both surfaced by the rev4 reviewer:
