...
- [ ] Slice 5: doc updates + card-completion wrap (grants the per-card [`CHANGELOG.md`][changelog] edit permission)
  ...
  - [ ] [`TODAY.md`][today]: update the products "still waiting for" list — `DjangoConnectionField` moves from waiting to shipped (or note products' Relay-connection activation tracking, lit up at fakeshop activation per [`TODO-BETA-062-0.1.5`][kanban]); keep the file products-centric.
...
- **Slice 5 — package docs**
  ...
  - [`TODAY.md`][today]: move `DjangoConnectionField` off the products "still waiting for" list (or note its activation tracking, lit up at fakeshop activation per [`TODO-BETA-062-0.1.5`][kanban]); keep the file products-centric.
