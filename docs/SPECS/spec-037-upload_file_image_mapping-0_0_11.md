...
> broader products/fakeshop activation stays [`TODO-BETA-061-0.1.5`][kanban]. The
...
([`TODO-BETA-061-0.1.5`][kanban]); the tension is recorded, not silently
resolved.
...
- **A live fakeshop file-upload surface** — deferred to fakeshop activation
  ([`TODO-BETA-061-0.1.5`][kanban]); this card covers both directions with
