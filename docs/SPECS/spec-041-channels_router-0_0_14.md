...
- **Revision 1** — initial draft authored from the [`WIP-ALPHA-041-0.0.14`][kanban]
  ...
  the migration-guide one-row handoff to [`TODO-BETA-066-0.1.7`][kanban]
...
The card's DoD hands [`TODO-BETA-066-0.1.7`][kanban] (Migration and adoption
...
- **The migration guide itself** — [`TODO-BETA-066-0.1.7`][kanban]; this card only
