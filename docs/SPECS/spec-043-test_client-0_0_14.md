...
- **Migration-guide prose.** The two import-diff rows and the
  `query()`-return-type delta are recorded for [`TODO-BETA-065-0.1.7`][kanban]
...
- **The migration guide itself** — [`TODO-BETA-065-0.1.7`][kanban]; this card
...
- [ ] The migration-guide handoff rows are recorded for
      [`TODO-BETA-065-0.1.7`][kanban] (the two import diffs + the three
