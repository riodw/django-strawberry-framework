...
Spec reference: `docs/SPECS/spec-017-apps-0_0_7.md` (Slice 2 sub-bullets at lines 64-66; Test plan at lines 374-396; Decisions 2 / 4 / 5 / 8)
...
2. **Test function names** (pinned by the spec at `docs/SPECS/spec-017-apps-0_0_7.md:384-391` and the stub at `tests/test_apps.py:9-46`):
...
3. **Test body shapes** (the stub's pseudo-block at `tests/test_apps.py:77-108` is canonical; the spec's Test plan at `docs/SPECS/spec-017-apps-0_0_7.md:382-391` is the prose contract):
...
- **No changes to `tests/base/test_init.py`.** Per Decision 3 at `docs/SPECS/spec-017-apps-0_0_7.md:257-270` and DoD item 3 at `docs/SPECS/spec-017-apps-0_0_7.md:456`. The `__all__` assertion at `tests/base/test_init.py:35-44` is byte-identical to baseline after Slice 2.
