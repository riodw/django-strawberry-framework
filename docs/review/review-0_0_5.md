...
DRY rule: every `rev-*.md` artifact must include a `## DRY analysis` section before merging; repeated logic, parallel data flows, near-copies, and repeated string/key/tuple literals are review-time defects.
