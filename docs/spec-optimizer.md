...
O4 was extracted out of this document during implementation. The O4 design record remains in `docs/spec-optimizer_nested_prefetch_chains.md`; keep detailed O4 rationale there rather than duplicating it here.
...
## O4 extraction
The detailed O4 implementation record lives in `docs/spec-optimizer_nested_prefetch_chains.md`. This parent spec only records the shipped behavior at a high level.
