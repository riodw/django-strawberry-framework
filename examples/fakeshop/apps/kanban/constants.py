...
TRACKED_FILE_PATHS = (
    ...
    "examples/fakeshop/apps/kanban/tests/test_uuid.py",
    "examples/fakeshop/apps/kanban/tests/test_worklog.py",
    "examples/fakeshop/apps/library/tests/__init__.py",
    "examples/fakeshop/apps/library/tests/test_generic_connection.py",
    "examples/fakeshop/apps/library/tests/test_generic_connection_sharded.py",
    ...
    "examples/fakeshop/test_query/test_library_shapes_api.py",
    ...
    "tests/optimizer/test_lateral_fetch.py",
    "tests/optimizer/test_multi_db.py",
    "tests/optimizer/test_nested_fetch.py",
    ...
    "tests/optimizer/test_single_parent_fetch.py",
...
TRACKED_DIRECTORY_PATHS = (
    ...
    "django_strawberry_framework/templates/",
