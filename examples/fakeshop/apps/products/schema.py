...
filters, `TODO-ALPHA-022-0.0.8` orders, `TODO-ALPHA-023-0.0.9` `DjangoConnectionField`,
`TODO-ALPHA-026-0.0.10` permissions, `TODO-BETA-037-0.1.1` fieldsets,
`TODO-BETA-038-0.1.2` search, `TODO-BETA-039-0.1.3` aggregates). Each `*Type`
...
# from django_strawberry_framework import DjangoConnectionField      # TODO-ALPHA-023-0.0.9
# from django_strawberry_framework import apply_cascade_permissions  # TODO-ALPHA-026-0.0.10
# from apps.products import aggregates, filters, orders              # TODO-ALPHA-021-0.0.8 (filters) + TODO-ALPHA-022-0.0.8 (orders) + TODO-BETA-039-0.1.3 (aggregates)
# from apps.products import fields as fieldsets                      # TODO-BETA-037-0.1.1
...
class CategoryType(DjangoType):
    class Meta:
        ...
        # search_fields = ("name", "description")           # needs TODO-BETA-038-0.1.2
        ...
        # aggregate_class = aggregates.CategoryAggregate    # needs TODO-BETA-039-0.1.3 + aggregates.py
        # fields_class = fieldsets.CategoryFieldSet         # needs TODO-BETA-037-0.1.1 + fields.py

    # Future cascade-permission visibility hook — uncomment when TODO-ALPHA-026-0.0.10 ships:
    #
    # @classmethod
...
class ItemType(DjangoType):
    class Meta:
        ...
        # Future Layer-3 additions — uncomment each as the relevant card ships:
        # interfaces = (relay.Node,)                                                  # works today (DONE-011)
        # search_fields = ("name", "description", "category__name", "category__description")  # needs TODO-BETA-038-0.1.2
        ...
        # aggregate_class = aggregates.ItemAggregate     # needs TODO-BETA-039-0.1.3 + aggregates.py
        # fields_class = fieldsets.ItemFieldSet          # needs TODO-BETA-037-0.1.1 + fields.py
...
class PropertyType(DjangoType):
    class Meta:
        ...
        # aggregate_class = aggregates.PropertyAggregate  # needs TODO-BETA-039-0.1.3 + aggregates.py
        # fields_class = fieldsets.PropertyFieldSet       # needs TODO-BETA-037-0.1.1 + fields.py
...
class EntryType(DjangoType):
    class Meta:
        ...
        fields = (
            "id",
            "value",
            "description",  # Future: drop this entry to exercise field-level permission gating (TODO-ALPHA-026-0.0.10)
            "property",
            "item",
            "is_private",
            "created_date",
        ...
        # Future Layer-3 additions — uncomment each as the relevant card ships:
        # interfaces = (relay.Node,)                                # works today (DONE-011)
        # search_fields = ("value", "property__name", "item__name") # needs TODO-BETA-038-0.1.2
        ...
        # aggregate_class = aggregates.EntryAggregate  # needs TODO-BETA-039-0.1.3 + aggregates.py
        # fields_class = fieldsets.EntryFieldSet       # needs TODO-BETA-037-0.1.1 + fields.py
...
class Query:
    ...
    # Future shape — once TODO-ALPHA-023-0.0.9 (`DjangoConnectionField` + Relay
