...
from fakeshop.schema import schema
...
def index(request):
    ...
    return HttpResponse("""
        ...
        <h3>Seed Data</h3>
        <ul>
            <li><a href="/admin/products/item/?seed_data=5">Seed 5 per provider</a></li>
            <li><a href="/admin/products/item/?seed_data=50">Seed 50 per provider</a></li>
        </ul>
        <h3>Delete Data</h3>
        <ul>
            <li><a href="/admin/products/item/?delete_data=10">Delete first 10 items</a></li>
            <li><a href="/admin/products/item/?delete_data=all">Delete all items &amp; entries</a></li>
            <li><a href="/admin/products/item/?delete_data=everything">Wipe all tables</a></li>
        </ul>
        <h3>Create Users</h3>
        <ul>
