...
# add validation/storage coverage for accepted interfaces, rejected malformed
# ``Meta.interfaces`` values, duplicate entries, DjangoType self-references,
# empty tuples, direct Relay inheritance, and composite primary keys.
